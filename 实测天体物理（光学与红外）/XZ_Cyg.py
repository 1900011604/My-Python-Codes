...
sigma_const_B_1 = [((2.5*Noise_Ref_Src_Sky_B_1[i]/Ref_Src_Sky_B_1[i])**2 + 0.01**2/3)**0.5 for i in range(30)]

const_B_2 = [11.26+2.5*np.log10(i) for i in Ref_Src_Sky_B_2]

sigma_const_B_2 = [((2.5*Noise_Ref_Src_Sky_B_2[i]/Ref_Src_Sky_B_2[i])**2 + 0.01**2/3)**0.5 for i in range(30)]
...
sigma_const_B_3 = [((2.5*Noise_Ref_Src_Sky_B_3[i]/Ref_Src_Sky_B_3[i])**2 + 0.01**2/3)**0.5 for i in range(30)]
...
sigma_avg_const_B = [(((const_B_1[i]-const_B[i])**2+(const_B_2[i]-const_B[i])**2+(const_B_3[i]-const_B[i])**2)/6)**0.5 for i in range(30)]
...
sigma_const_V_1 = [((2.5*Noise_Ref_Src_Sky_V_1[i]/Ref_Src_Sky_V_1[i])**2 + 0.01**2/3)**0.5 for i in range(30)]

const_V_2 = [9.96+2.5*np.log10(i) for i in Ref_Src_Sky_V_2]

sigma_const_V_2 = [((2.5*Noise_Ref_Src_Sky_V_2[i]/Ref_Src_Sky_V_2[i])**2 + 0.01**2/3)**0.5 for i in range(30)]

const_V_3 = [10.50+2.5*np.log10(i) for i in Ref_Src_Sky_V_3[0:21]] + [8.20+2.5*np.log10(i) for i in Ref_Src_Sky_V_3[21:30]]

sigma_const_V_3 = [((2.5*Noise_Ref_Src_Sky_V_3[i]/Ref_Src_Sky_V_3[i])**2 + 0.01**2/3)**0.5 for i in range(30)]
...
sigma_avg_const_V = [(((const_V_1[i]-const_V[i])**2+(const_V_2[i]-const_V[i])**2+(const_V_3[i]-const_V[i])**2)/6)**0.5 for i in range(30)]
