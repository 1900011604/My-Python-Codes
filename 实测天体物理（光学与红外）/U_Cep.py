...
sigma_const_B_1 = [2.5*Noise_Ref_Src_Sky_B_1[i]/Ref_Src_Sky_B_1[i] for i in range(24)]

const_B_2 = [10.67+2.5*np.log10(i) for i in Ref_Src_Sky_B_2]

sigma_const_B_2 = [2.5*Noise_Ref_Src_Sky_B_2[i]/Ref_Src_Sky_B_2[i] for i in range(24)]

const_B_3 = [10.63+2.5*np.log10(i) for i in Ref_Src_Sky_B_3]

sigma_const_B_3 = [2.5*Noise_Ref_Src_Sky_B_3[i]/Ref_Src_Sky_B_3[i] for i in range(24)]
...
sigma_avg_const_B = [(((sigma_const_B_1[i]-sigma_const_B[i])**2+(sigma_const_B_2[i]-sigma_const_B[i])**2+(sigma_const_B_3[i]-sigma_const_B[i])**2)/6)**0.5 for i in range(24)]
...
sigma_const_V_1 = [2.5*Noise_Ref_Src_Sky_V_1[i]/Ref_Src_Sky_V_1[i] for i in range(24)]

const_V_2 = [10.47+2.5*np.log10(i) for i in Ref_Src_Sky_V_2]

sigma_const_V_2 = [2.5*Noise_Ref_Src_Sky_V_2[i]/Ref_Src_Sky_V_2[i] for i in range(24)]

const_V_3 = [10.15+2.5*np.log10(i) for i in Ref_Src_Sky_V_3]

sigma_const_V_3 = [2.5*Noise_Ref_Src_Sky_V_3[i]/Ref_Src_Sky_V_3[i] for i in range(24)]
...
sigma_avg_const_V = [(((sigma_const_V_1[i]-sigma_const_V[i])**2+(sigma_const_V_2[i]-sigma_const_V[i])**2+(sigma_const_V_3[i]-sigma_const_V[i])**2)/6)**0.5 for i in range(24)]
